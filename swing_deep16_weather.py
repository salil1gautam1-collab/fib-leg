"""TEST 16 — WEATHER SPLIT for the live SCALP 1H@0.618 ladder combo.
Owner go 2026-07-16 ("lets run the weather-split study") after 8 live days showed the
combo bleeding on running/nervous days (-28.6R) and earning on calm days (+6.3R), the
same fingerprint as gamma's weather table. Question: did the 11-year edge live only in
quiet sideways weather, or did it survive hostile days too?
...
RUNGS = {0.618: (0.5, 0.382, 0.236, 0.0)}
RUNG_F = (0.382, 0.5, 0.618, 0.786, 0.886)
STK = {(60, 0.618): (.0031, 375, True)}      # the LIVE scalper combo
CUSH886 = {60: .0042}
COST = 0.05

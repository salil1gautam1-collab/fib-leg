"""Does A+ (mountain/valley confluence in the zone) earn its place? v5 legs, 2H book382,
lock-at-B. Compares baseline / M/W+trend / A+ / M/W+trend+A+strict. Train/test/full net R @0.10%."""
...
print(f"{len(tickers)} stocks, 2H book382 v5, lock-at-B — A+ STRICT A/B\n", flush=True)
...
CFG = {
    ...
    "A+strict":        cfg(require_aplus_strict=True),
    "M/W+trend+A+strict":   cfg(require_mw=True, require_htf=True, require_aplus_strict=True),
}

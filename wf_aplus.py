...
lock-at-B. Compares baseline / M/W+trend / A+ / M/W+trend+A+. Train/test/full net R @0.10%."""
...
print(f"{len(tickers)} stocks, 2H book382 v5, lock-at-B — A+ A/B\n", flush=True)
...
CFG = {
    ...
    "A+ only":        cfg(require_aplus=True),
    "M/W+trend+A+":   cfg(require_mw=True, require_htf=True, require_aplus=True),
}

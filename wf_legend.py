"""Leg-end rule A/B: does re-anchoring at 0.50 (your rule) or 0.618 beat v5's 0.382?
M/W+trend, 2H book382, lock-at-B. Only book_reanchor_ratio changes. Train/test/full @0.10%."""
...
print(f"{len(tickers)} stocks, 2H book382, M/W+trend, lock-at-B — leg-end A/B\n", flush=True)
...
def cfg(rr):
    ...
    c.require_mw=True; c.require_htf=True
    c.book_reanchor_ratio=rr
    c.targets=(0.95,1.272,1.618); c.target_fractions=(1/3,1/3,1/3); return c
CFG = {"0.382 (v5)": cfg(0.0), "0.50 (your rule)": cfg(0.50), "0.618": cfg(0.618)}

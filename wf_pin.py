"""Do pin bars earn their place? v5 legs, 2H book382, lock-at-B. Tests pin at the leg
origin (reversal signal) alone and with trend, and M/W-OR-pin. Train/test/full @0.10%."""
...
print(f"{len(tickers)} stocks, 2H book382, lock-at-B — pin A/B\n", flush=True)
...
CFG = {
    ...
    "pin+trend":        cfg(require_pin=True, require_htf=True),
    "(M/W|pin)+trend":  cfg(require_mw=True, reversal_pin=True, require_htf=True),
}
